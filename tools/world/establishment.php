<?php
  //SQL Connect
   ...
   <div class="mainbox col-lg-10 col-xs-12 col-lg-offset-1">
     ...
     <!-- Page Header -->
     <div class="col-md-12">
     <div class="pagetitle" id="pgtitle">Establishments</div>
   </div>
   ...
   <table id="establishment" class="table table-condensed table-striped table-responsive dt-responsive" cellspacing="0" width="100%">
           ...
           <tbody>
             <?php
               $sqlcompendium = "SELECT * FROM world WHERE type LIKE 'establishment' AND worlduser LIKE '$loguser'";
               ...
               echo $entry;
               echo ('</a></td>');
               echo ('<td><a href="world.php?id='.$row['est_type'].'">');
               echo $row['est_type'];
               echo ('</a></td>');
               echo ('<td><a href="world.php?id='.$row['est_location'].'">');
               echo $row['est_location'];
               echo ('</a></td>');
               echo ('</tr>');
